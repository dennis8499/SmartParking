...
$PageTitle = '商家資訊系統';
$sqlcmd = "SELECT count(*) AS reccount FROM parking WHERE type='business'";
...
$sqlcmd = "SELECT * FROM parking WHERE type='business' LIMIT $StartRec,$ItemPerPage ";
...
<html>
	...
	<body>
	  <div id="wrapper">
        ...
        <section id = "main">
		<div style="text-align:center;margin:0;font-size:20px;font-weight:bold;">商家表</div>
