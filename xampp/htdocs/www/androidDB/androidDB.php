...
{    	
	...
	else if(window.XMLHttpRequest)
	{
	 ...
	 xmlHTTP1.open("GET","http://192.168.43.108:80/www/androidDB/androidDB_total.php",true);
...
xmlHTTP2.open("GET","http://192.168.43.108:80/www/androidDB/androidDB_remainder.php",true);
...
xmlHTTP3.open("GET","http://192.168.43.108:80/www/androidDB/androidDB_block1.php",true);
...
xmlHTTP4.open("GET","http://192.168.43.108:80/www/androidDB/androidDB_block2.php",true);
...
xmlHTTP5.open("GET","http://192.168.43.108:80/www/androidDB/androidDB_block3.php",true);
