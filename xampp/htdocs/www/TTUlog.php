...
$PageTitle = 'TTULOG系統';
$sqlcmd = "SELECT count(*) AS reccount FROM ttulog";
...
$sqlcmd = "SELECT * FROM ttulog LIMIT $StartRec,$ItemPerPage";
...
$PrevLink = $NextLink = '';
if (!empty($PrevPage)) 
    $PrevLink = '<a href="TTUlog.php?Page=' . $PrevPage . '">上一頁</a>';
if (!empty($NextPage)) 
    $NextLink = '<a href="TTUlog.php?Page=' . $NextPage . '">下一頁</a>';
