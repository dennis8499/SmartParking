<html>
    ...
    {    	
		...
		else if(window.XMLHttpRequest)
		{
         ...
         xmlHTTP1.open("GET","TTA_total.php",true);
   ...
   if(window.ActiveXObject)
    ...
    xmlHTTP2.open("GET","TTA_remainder.php",true);
   ...
   if(window.ActiveXObject)
    ...
    xmlHTTP3.open("GET","TTA_block1.php",true);
        xmlHTTP3.onreadystatechange=function check_user()
        {
            if(xmlHTTP3.readyState == 4)
            {
                if(xmlHTTP3.status == 200)
                {
                    ...
                    document.getElementById("tta1").innerHTML=str;
                }
            }
        }
        xmlHTTP3.send(null);
  ...
  if(window.ActiveXObject)
    ...
    xmlHTTP4.open("GET","TTA_block2.php",true);
        xmlHTTP4.onreadystatechange=function check_user()
        {
            if(xmlHTTP4.readyState == 4)
            {
                if(xmlHTTP4.status == 200)
                {
                    ...
                    document.getElementById("tta2").innerHTML=str;
                }
            }
        }
        xmlHTTP4.send(null);
   ...
   if(window.ActiveXObject)
    ...
    xmlHTTP5.open("GET","TTA_block3.php",true);
        xmlHTTP5.onreadystatechange=function check_user()
        {
            if(xmlHTTP5.readyState == 4)
            {
                if(xmlHTTP5.status == 200)
                {
                    ...
                    document.getElementById("tta3").innerHTML=str;
                }
            }
        }
        xmlHTTP5.send(null);
